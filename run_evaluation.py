...
class EvaluateAll:
    ...
    def run_evaluation(self):
        ...
        for im_name in im_list:
            ...
            #img = preprocess.contrast_brightness_correction_px(img)
            #img = preprocess.contrast_brightness_correction_csa(img)
            #img = preprocess.adjust_gamma(img, 0.9)
            #img = preprocess.histogram_equlization_bnw(img)
            #img = preprocess.edge_detection(img)
            ...
            #prediction_list = cascade_detector.detectYOLO(img)
